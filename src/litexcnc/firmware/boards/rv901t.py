"""
The definition for the RV901T is not part of litex_boards. Therefore
this file is taken from:
    https://github.com/q3k/chubby75/blob/master/rv901t/platform.py
...
# Platform ----------------------------------------------------------
class RV901T_Platform(XilinxPlatform):
