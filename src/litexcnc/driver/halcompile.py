...
def build_rt(tempdir, filename, mode, origfilename):
    ...
    f = open(os.path.join(os.path.dirname(__file__), 'config.h'),'w')
    print("/**", file=f)
    ...
    print("", file=f)
    print(f"#define EMC2_RTLIB_DIR \"{os.path.join(os.path.dirname(os.path.dirname(find_modinc())), 'rtlib')}\"", file=f)
    print("", file=f)
