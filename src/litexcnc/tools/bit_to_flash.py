...
def bit_to_flash(file_in, file_out):
    """Converts the bit-file to a .svf-file which is permanent in flash."""
    with open(file_in, 'rb') as bitf:
        bs = bitf.read()
